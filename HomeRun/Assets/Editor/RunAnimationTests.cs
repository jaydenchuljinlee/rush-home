...
public class RunAnimationTests : ICallbacks
{
    private static RunAnimationTests _instance;
    ...
    {
        _instance = new RunAnimationTests();
        _results.Clear();
        _passed = 0;
        _failed = 0;
    ...
    {
        Debug.Log($"[AnimTest] 완료 - PASS: {_passed}, FAIL: {_failed}");
