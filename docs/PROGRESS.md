...
| F-02 | 달리는 지면 | 대기 | 입력 시 지면이 끊김 없이 스크롤 |

### 게임플레이

| # | Feature | 선행 | 상태 | 완료 기준 |
|---|---------|------|------|----------|
| F-03 | 플레이어 캐릭터 | F-02 | 대기 | Space로 점프, 아래로 슬라이딩 동작 |
| F-04 | 장애물 시스템 | F-03 | 대기 | 장애물 등장 + 충돌 시 게임오버 |
...
| # | Feature | 선행 | 상태 | 완료 기준 |
|---|---------|------|------|----------|
| F-05 | 인게임 HUD / 게임오버 | F-04 | 대기 | 시작/플레이/게임오버 전체 흐름 동작 |
